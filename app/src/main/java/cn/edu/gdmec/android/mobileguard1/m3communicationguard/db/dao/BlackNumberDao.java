package cn.edu.gdmec.android.mobileguard1.m3communicationguard.db.dao;
...
import cn.edu.gdmec.android.mobileguard1.m3communicationguard.db.BlackNumberOpenHelper;
import cn.edu.gdmec.android.mobileguard1.m3communicationguard.entity.BlackContactInfo;
...
public class BlackNumberDao {
    ...
    public int getTotalNumber(){
        SQLiteDatabase db = blackNumberOpenHelper.getReadableDatabase();
        Cursor cutsor = db.rawQuery("select count(*) from blacknumber",null);
        cutsor.moveToNext();
        int count = cutsor.getInt(0);
        cutsor.close();
        db.close();
        return count;
    }
